...
export default function StudentBatchDetailsPage() {
  ...
  const classSchedule = [
    { day: 'Monday', subjects: ['Data Structures', 'Database Systems', 'Computer Networks'] },
    { day: 'Tuesday', subjects: ['Operating Systems', 'Software Engineering', 'Mathematics III'] },
    { day: 'Wednesday', subjects: ['Data Structures (Lab)', 'Database Systems', 'Computer Networks'] },
    { day: 'Thursday', subjects: ['Operating Systems', 'Software Engineering (Lab)', 'Mathematics III'] },
    { day: 'Friday', subjects: ['Data Structures', 'Database Systems', 'Elective'] },
  ]

  const classmates = [
    { name: 'Aarav Sharma', roll: 'ROLL-001' },
    { name: 'Priya Patel', roll: 'ROLL-002' },
    { name: 'Rahul Verma', roll: 'ROLL-003' },
    { name: 'Sneha Gupta', roll: 'ROLL-004' },
    { name: 'Arjun Singh', roll: 'ROLL-005' },
  ]
      ...
      <motion.div initial="hidden" animate="visible" variants={containerVariants} className="space-y-6">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <motion.div variants={itemVariants} className="card p-5">
              <h3 className="text-lg font-semibold text-neutral-800 mb-4">Classmates</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                {classmates.map((cm) => (
                  <div key={cm.roll} className="flex items-center gap-3 p-3 rounded-xl bg-neutral-50">
                    ...
                    <div>
                      <p className="text-sm font-medium text-neutral-800">{cm.name}</p>
                      <p className="text-xs text-neutral-400">{cm.roll}</p>
                    </div>
                  </div>
                ))}
              </div>
