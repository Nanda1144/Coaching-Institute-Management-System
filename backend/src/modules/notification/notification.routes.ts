...
router.post('/', authenticate, authorize(UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.HOD, UserRole.FACULTY), requirePermission(Permission.SEND_NOTIFICATION), validate(createNotificationSchema), notificationController.send);
